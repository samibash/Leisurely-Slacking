...
async function seed() {
    ...
    const destination01= await Destination.create({
    ...
    const destination02= await Destination.create({
    ...
    const destination03= await Destination.create({
    ...
    const destination04=  await Destination.create({
    ...
    const destination05= await Destination.create({
    ...
    const destination06=  await Destination.create({
    ...
    const destination07=  await Destination.create({
    ...
    const destination08=  await Destination.create({
    ...
    const destination09= await Destination.create({
    ...
    const destination10=  await Destination.create({
    ...
    const destination11=  await Destination.create({
    ...
    const destination12=  await Destination.create({
    ...
    await review01.setDestination(destination01)
    await review02.setDestination(destination02)
    await review03.setDestination(destination03)
    await review04.setDestination(destination04)
    await review05.setDestination(destination05)
    await review06.setDestination(destination06)
    await review07.setDestination(destination07)
    await review08.setDestination(destination08)
    await review09.setDestination(destination09)
    await review10.setDestination(destination10)
    await review11.setDestination(destination11)
    await review12.setDestination(destination12)

    await review01.setBar(bar01)
    await review01.setBar(bar02)
    await review02.setBar(bar03)
    await review02.setBar(bar04)
    await review03.setBar(bar05)
    await review03.setBar(bar06)
    await review04.setBar(bar07)
    await review04.setBar(bar08)
    await review05.setBar(bar09)
    await review05.setBar(bar10)
    await review06.setBar(bar11)
    await review06.setBar(bar12)
    await review07.setBar(bar13)
    await review07.setBar(bar14)
    await review08.setBar(bar15)
    await review08.setBar(bar16)
    await review09.setBar(bar17)
    await review09.setBar(bar18)
    await review10.setBar(bar19)
    await review10.setBar(bar20)
    await review11.setBar(bar21)
    await review11.setBar(bar22)
    await review12.setBar(bar23)
    await review12.setBar(bar24)
}
